...
def get_attribute_value(shop_api:'shop_pybind.ShopCore', object_name:str, object_type:str, attribute_name:str, datatype:str, dataframe:bool=True) -> Any:
    value = None
    if datatype == 'int': 
...
def get_xyt_attribute(shop_api:'shop_pybind.ShopCore', object_name:str, object_type:str, attribute_name:str, start:pd.Timestamp, end:pd.Timestamp, dataframe:bool=True) -> Union[List[pd.Series], List[Dict]]:
...
def get_attribute_info(shop_api:'shop_pybind.ShopCore', object_type:str, attribute_name:str, key:str='') -> Union[str,Dict[str,str]]:
    if key:
...
def get_object_info(shop_api:'shop_pybind.ShopCore', object_type:str, key:str='') -> Union[str,Dict[str,str]]:
    if key:
...
def set_attribute(shop_api:'shop_pybind.ShopCore', object_name:str, object_type:str, attribute_name:str, datatype:str, value:Any) -> None:
...
def get_time_resolution(shop_api:'shop_pybind.ShopCore') -> Dict:
    tz_name = get_shop_timzone_name(shop_api)
...
def get_shop_timzone_name(shop_api:'shop_pybind.ShopCore') -> str:
    try:
