...
p2g1.turb_eff_curves.set([pd.Series([80, 95, 90], index=[25, 90, 100], name=90), pd.Series([82, 98, 92], index=[25, 90, 100], name=100)])

#Connect objects
rsv1.connect().junction['Junction1'].add()
rsv2.connect().junction['Junction1'].add()
junc1.connect().plant['Plant1'].add()
plant1.connect().reservoir['Reservoir3'].add()
rsv3.connect().junction['Junction2'].add()
creek1.connect().junction['Junction2'].add()
junc2.connect().plant['Plant2'].add()
